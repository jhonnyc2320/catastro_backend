...
def cargar_datos_movil(self, data):
    list_predios = data
        ...
        for json_predio in list_predios:
            ...
            if unidadades:
                for construcciones in unidadades:
                    ...
                    # Obtener instancias de relaciones foráneas
                    # instance_anexo_tipo = get_instance(LcAnexotipo, 'des_anexotipo', anexo_tipo)
            ...
            if fuente_administrativa:
                ...
                id_adquisicion = fuente_administrativa.get('id_adquisicion')
            ...
            predios_no_cargados.get('predios').append(id_predio)
            predios_no_cargados['motivo'] = 'Predios cargados exitosamente'
            predios_no_cargados_list.append(predios_no_cargados)
